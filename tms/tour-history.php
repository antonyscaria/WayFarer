...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">WayFarer</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<td><a href="comment.php?bkid=<?php echo htmlentities($result->bookid);?>&comment=<?php echo htmlentities($result->comment);?>"><?php echo htmlentities($result->comment);?></a></td>
